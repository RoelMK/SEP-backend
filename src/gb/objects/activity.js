...
var Activity = /** @class */ (function (_super) {
     ...
     */
    Activity.prototype.getActivityById = function (activityId, headers, query) {
        return __awaiter(this, void 0, void 0, function () {
            var activity;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.gamebus.get("activities/" + activityId, headers, query, this.authRequired)];
                    case 1:
                        activity = _a.sent();
