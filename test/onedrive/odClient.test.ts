...
describe('with mocked activities get call', () => {
    ...
    const request = mockOnedriveRequest((obj) => {
          ...
          return Promise.resolve({
            data : {
              ...
              value: [
                ...
                {
                  '@microsoft.graph.downloadUrl': 'https://sjemfg.am.files.1drv.com/y4mpfyA9tmgSztWIjWEjYRjbywywIK0UKVAg4giaTgWN2oMrwIG2bE9K7UoHKGn1MD04yfg1NxOA4-8Ac7kPD57MgHmGpL3LfWM37kyBR6r4iHjxZPSgVQcoU5135aef_ucSFTJpuSQ1-C756IIAD0csjJH0w6tDUDTMTZoltPvSO4YIKepTybSvx9o185RjHAD',
                ...
                {
                  '@microsoft.graph.downloadUrl': 'https://public.am.files.1drv.com/y4mXKcTYrkLkI5YhTdlJ-XexQc8hvdXO2YlT7msCArZ_qXjVc8Ox5p9u0ffmZTMPqdUlX-bTj4nyPheuFRSPthU41lMpZyl-zsa_LAhfn_ngO6Pr3XvvlQ3gZKc8kgFsqbw7QRFVa8kfD3JiKCg4ZjsxX0MRZ6jl4_nGxvzRL-4zHIbyK1Gk8VuGZqg4wRciwldMmU4E7Cfvl8v-KW1shTVk2yUTwWq7i3NUj1TtAo0VqU',
                  ...
                  file: {
                    ...
                    hashes: {
                      ...
                      sha256Hash: '83C1836588DF9978004E2B476C9BCA981E02DDE2CEFDEAAB40B619801EE23E19'
                    }
                  },
                  fileSystemInfo: {
        ...
        if(obj.url === "https://graph.microsoft.com/v1.0/me/drive/items/4025833D974F9FE8!112/workbook/worksheets('Sheet1')/tables") {
          return Promise.resolve({
            data: {
              '@odata.context': "https://graph.microsoft.com/v1.0/$metadata#users('diabettertest2%40outlook.com')/drive/items('4025833D974F9FE8%21112')/workbook/worksheets('Sheet1')/tables",
              value: [
                {
                  '@odata.id': "/users('diabettertest2%40outlook.com')/drive/items('4025833D974F9FE8%21112')/workbook/worksheets(%27%7B00000000-0001-0000-0000-000000000000%7D%27)/tables(%27%7B4732EEDC-239B-483E-BDDA-BC9853616E86%7D%27)",
