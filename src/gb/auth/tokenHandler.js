...
var TokenHandler = /** @class */ (function () {
     ...
     */
    function TokenHandler(gamebus, token) {
        var _this = this;
     ...
     */
    TokenHandler.prototype.generateToken = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!!this.gamebusToken) return [3 /*break*/, 2];
                        _a = this;
                        return [4 /*yield*/, this.login()];
                    case 1:
                        _a.gamebusToken = _b.sent();
                        _b.label = 2;
     ...
     * @returns Fresh token
     */
    TokenHandler.prototype.login = function () {
        return __awaiter(this, void 0, void 0, function () {
